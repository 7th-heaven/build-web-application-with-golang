...
![](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/images/2.5.rect_func_without_receiver.png?raw=true)
...
![](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/images/2.5.shapes_func_with_receiver_cp.png?raw=true)
...
> 如果一个method的receiver是T，你可以在一个_T类型的变量P上面调用这个method，而不需要_ P去调用这个method
...
* 上一章: [struct类型](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/02.4.md%3E)
* 下一节: [interface](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/02.6.md%3E)
