...
表单是一个包含表单元素的区域。表单元素（比如：文本域、下拉列表、单选框、复选框等等）是允许用户在表单中输入信息的元素。表单使用表单标签（\）定义。
...
![](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/images/navi4.png?raw=true)
...
* 上一章: [第三章总结](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/03.5.md%3E)
* 下一节: [处理表单的输入](https://github.com/7th-heaven/build-web-application-with-golang/tree/606abd586a7270d0e48762cf0454ba0fac330698/zh/04.1.md%3E)
